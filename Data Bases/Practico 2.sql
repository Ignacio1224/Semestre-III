...
-- Ejercicio 3
INSERT INTO ESTUDIANTE (ciEst, nomEst, mailEst, telEst) VALUES ('3.558.138-5','Andres Gonzalez','agonz@gmail.uy','99688988'); -- Ya existe una ciEst con este valor, se viola la restrici�n de PK

-- Ejercicio 4
-- Debido al error de la constraint visto en clase, la doy de baja y creo una nueva chequeando s�lo que sean letras en may�sculas.
...
DELETE FROM ESTUDIANTE WHERE codEst = (SELECT MAX(codEst) FROM ESTUDIANTE); DBCC CHECKIDENT (ESTUDIANTE, NORESEED); -- Como codCur es IDENTITY puedo eliminar el m�ximo siendo el �ltimo regustro
